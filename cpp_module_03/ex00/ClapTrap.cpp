...
void	ClapTrap::attack(const std::string &target)
{
	...
	std::cout << "ClapTrap: " << target << " take damage " << this->_attack_damage << std::endl;
	std::cout << "ClapTrap: " << this->_name << " <-1 energy point> " << std::endl;
	this->_energy_point--;
	std::cout << "ClapTrap: " << this->_name << " remain energy point = " << this->_energy_point << std::endl;
}

void	ClapTrap::takeDamage(unsigned int amount)
{
	this->_hit_point -= amount;
	std::cout << "ClapTrap: " << this->_name << " remaining hit point = " << this->_hit_point << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_energy_point <= 0)
	{
		std::cout << "ClapTrap: " << this->_name << " out of energy to use repair skill" << std::endl;
		return ;
	}
	if (this->_hit_point <= 0)
	{
	...
	this->_energy_point--;
	std::cout << "ClapTrap: " << this->_name << " repaired skill active" << std::endl;
	std::cout << "ClapTrap: " << this->_name << " be repair = " << amount << std::endl;
	if(this->_hit_point + amount >= 10)
		this->_hit_point = 10;
	else
		this->_hit_point += amount;
	std::cout << "ClapTrap: " << this->_name << " hit point status = "<< this->_hit_point << std::endl;
}
